 ...
 * @author Alan
 */
public class SimpleWordProcessor extends javax.swing.JFrame {
    ...
    private void saveJMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveJMenuItemActionPerformed
            ...
            int option = jfc.showSaveDialog(this); // the buttons in the dialog return an int, -1,0,1 etc for Approve (SAVE) | Cancel 
                            // similar to .showOpenDialog(this);
            if (option == JFileChooser.APPROVE_OPTION) {
                File f = jfc.getSelectedFile(); //figure out where you want to store contents of the text file, represents file object
                Path pathToFile = Paths.get(f.getPath()); //can also use .getAbsolutePath() // create path to the file
             ...
             try {
                Files.write(pathToFile, linesotoadd.getBytes(), StandardOpenOption.CREATE); //want to append this to the file
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SimpleWordProcessor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new SimpleWordProcessor().setVisible(true);
            }
        });
    }
